...
namespace Moderon
{
    ...
    partial class Form1 : Form
    {
        ...
        {
            CheckHumidSensors_spec(); // Поиск для датчиков влажности
            CheckChanSensors_spec(); // Поиск для канальных датчиков температуры
            CheckRoomSensor_spec(); // Поиск для комнатного датчика температуры
            CheckOutSensor_spec(); // Поиск для наружного датчика температуры
            CheckWatSensor_spec(); // Поиск для датчиков обратной воды 
        ...
        ///<summary>Поиск датчиков влажности в таблице сигналов по имени</summary>
        private void CheckHumidSensors_spec()
        {
            string s1 = "Комнатный датчик влажности";
            string s2 = "Канальный датчик влажности";
            if (AI1_combo.SelectedItem.ToString() == s1 || AI1_combo.SelectedItem.ToString() == s2)
            {   // AI1, ПЛК
                if (AI1_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI2_combo.SelectedItem.ToString() == s1 || AI2_combo.SelectedItem.ToString() == s2)
            {   // AI2, ПЛК
                if (AI2_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI3_combo.SelectedItem.ToString() == s1 || AI3_combo.SelectedItem.ToString() == s2)
            {   // AI3, ПЛК
                if (AI3_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI1bl1_combo.SelectedItem.ToString() == s1 || AI1bl1_combo.SelectedItem.ToString() == s2)
            {   // AI1, блок 1
                if (AI1bl1_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI2bl1_combo.SelectedItem.ToString() == s1 || AI2bl1_combo.SelectedItem.ToString() == s2)
            {   // AI2, блок 1
                if (AI2bl1_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI3bl1_combo.SelectedItem.ToString() == s1 || AI3bl1_combo.SelectedItem.ToString() == s2)
            {   // AI3, блок 1
                if (AI3bl1_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI1bl2_combo.SelectedItem.ToString() == s1 || AI1bl2_combo.SelectedItem.ToString() == s2)
            {   // AI1, блок 2
                if (AI1bl2_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI2bl2_combo.SelectedItem.ToString() == s1 || AI2bl2_combo.SelectedItem.ToString() == s2)
            {   // AI2, блок 2
                if (AI2bl2_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI3bl2_combo.SelectedItem.ToString() == s1 || AI3bl2_combo.SelectedItem.ToString() == s2)
            {   // AI3, блок 2
                if (AI3bl2_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI1bl3_combo.SelectedItem.ToString() == s1 || AI1bl3_combo.SelectedItem.ToString() == s2)
            {   // AI1, блок 3
                if (AI1bl3_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI2bl3_combo.SelectedItem.ToString() == s1 || AI2bl3_combo.SelectedItem.ToString() == s2)
            {   // AI2, блок 3
                if (AI2bl3_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
            if (AI3bl3_combo.SelectedItem.ToString() == s1 || AI3bl3_combo.SelectedItem.ToString() == s2)
            {   // AI3, блок 3
                if (AI3bl3_typeCombo.SelectedIndex == 0) humidSensorTotal_0_10++;
                else humidSensorTotal_4_20++;
            }
        }

        ///<summary>Поиск канальных датчиков температуры в таблице сигналов по имени</summary>
        private void CheckChanSensors_spec()
        {
            string s3 = "Канальный датчик Т приточного воздуха";
            string s4 = "Канальный датчик Т вытяжного воздуха";
            string s5 = "Датчик температуры защиты рекуператора";
            if (AI1_combo.SelectedItem.ToString() == s3 || AI1_combo.SelectedItem.ToString() == s4 ||
                    AI1_combo.SelectedItem.ToString() == s5)
            {   // AI1, ПЛК
                if (AI1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI2_combo.SelectedItem.ToString() == s3 || AI2_combo.SelectedItem.ToString() == s4 ||
                    AI2_combo.SelectedItem.ToString() == s5)
            {   // AI2, ПЛК
                if (AI2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI3_combo.SelectedItem.ToString() == s3 || AI3_combo.SelectedItem.ToString() == s4 ||
                    AI3_combo.SelectedItem.ToString() == s5)
            {   // AI3, ПЛК
                if (AI3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI4_combo.SelectedItem.ToString() == s3 || AI4_combo.SelectedItem.ToString() == s4 ||
                    AI4_combo.SelectedItem.ToString() == s5)
            {   // AI4, ПЛК
                if (AI4_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI4_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI5_combo.SelectedItem.ToString() == s3 || AI5_combo.SelectedItem.ToString() == s4 ||
                    AI5_combo.SelectedItem.ToString() == s5)
            {   // AI5, ПЛК
                if (AI5_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI5_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI6_combo.SelectedItem.ToString() == s3 || AI6_combo.SelectedItem.ToString() == s4 ||
                    AI6_combo.SelectedItem.ToString() == s5)
            {   // AI6, ПЛК
                if (AI6_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI6_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI1bl1_combo.SelectedItem.ToString() == s3 || AI1bl1_combo.SelectedItem.ToString() == s4 ||
                    AI1bl1_combo.SelectedItem.ToString() == s5)
            {   // AI1, блок 1
                if (AI1bl1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI1bl1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI2bl1_combo.SelectedItem.ToString() == s3 || AI2bl1_combo.SelectedItem.ToString() == s4 ||
                    AI2bl1_combo.SelectedItem.ToString() == s5)
            {   // AI2, блок 1
                if (AI2bl1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI2bl1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI3bl1_combo.SelectedItem.ToString() == s3 || AI3bl1_combo.SelectedItem.ToString() == s4 ||
                    AI3bl1_combo.SelectedItem.ToString() == s5)
            {   // AI3, блок 1
                if (AI3bl1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI3bl1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI4bl1_combo.SelectedItem.ToString() == s3 || AI4bl1_combo.SelectedItem.ToString() == s4 ||
                    AI4bl1_combo.SelectedItem.ToString() == s5)
            {   // AI4, блок 1
                if (AI4bl1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI4bl1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI5bl1_combo.SelectedItem.ToString() == s3 || AI5bl1_combo.SelectedItem.ToString() == s4 ||
                    AI5bl1_combo.SelectedItem.ToString() == s5)
            {   // AI5, блок 1
                if (AI5bl1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI5bl1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI6bl1_combo.SelectedItem.ToString() == s3 || AI6bl1_combo.SelectedItem.ToString() == s4 ||
                    AI6bl1_combo.SelectedItem.ToString() == s5)
            {   // AI6, блок 1
                if (AI6bl1_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI6bl1_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI1bl2_combo.SelectedItem.ToString() == s3 || AI1bl2_combo.SelectedItem.ToString() == s4 ||
                    AI1bl2_combo.SelectedItem.ToString() == s5)
            {   // AI1, блок 2
                if (AI1bl2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI1bl2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI2bl2_combo.SelectedItem.ToString() == s3 || AI2bl2_combo.SelectedItem.ToString() == s4 ||
                    AI2bl2_combo.SelectedItem.ToString() == s5)
            {   // AI2, блок 2
                if (AI2bl2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI2bl2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI3bl2_combo.SelectedItem.ToString() == s3 || AI3bl2_combo.SelectedItem.ToString() == s4 ||
                    AI3bl2_combo.SelectedItem.ToString() == s5)
            {   // AI3, блок 2
                if (AI3bl2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI3bl2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI3bl2_combo.SelectedItem.ToString() == s3 || AI3bl2_combo.SelectedItem.ToString() == s4 ||
                    AI3bl2_combo.SelectedItem.ToString() == s5)
            {   // AI3, блок 2
            ...
            if (AI4bl2_combo.SelectedItem.ToString() == s3 || AI4bl2_combo.SelectedItem.ToString() == s4 ||
                    AI4bl2_combo.SelectedItem.ToString() == s5)
            {   // AI4, блок 2
                if (AI4bl2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI4bl2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI5bl2_combo.SelectedItem.ToString() == s3 || AI5bl2_combo.SelectedItem.ToString() == s4 ||
                    AI5bl2_combo.SelectedItem.ToString() == s5)
            {   // AI5, блок 2
                if (AI5bl2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI5bl2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI6bl2_combo.SelectedItem.ToString() == s3 || AI6bl2_combo.SelectedItem.ToString() == s4 ||
                    AI6bl2_combo.SelectedItem.ToString() == s5)
            {   // AI6, блок 2
                if (AI6bl2_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI6bl2_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI1bl3_combo.SelectedItem.ToString() == s3 || AI1bl3_combo.SelectedItem.ToString() == s4 ||
                    AI1bl3_combo.SelectedItem.ToString() == s5)
            {   // AI1, блок 3
                if (AI1bl3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI1bl3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI2bl3_combo.SelectedItem.ToString() == s3 || AI2bl3_combo.SelectedItem.ToString() == s4 ||
                    AI2bl3_combo.SelectedItem.ToString() == s5)
            {   // AI2, блок 3
                if (AI2bl3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI2bl3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI3bl3_combo.SelectedItem.ToString() == s3 || AI3bl3_combo.SelectedItem.ToString() == s4 ||
                    AI3bl3_combo.SelectedItem.ToString() == s5)
            {   // AI3, блок 3
                if (AI3bl3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI3bl3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI4bl3_combo.SelectedItem.ToString() == s3 || AI4bl3_combo.SelectedItem.ToString() == s4 ||
                    AI4bl3_combo.SelectedItem.ToString() == s5)
            {   // AI4, блок 3
                if (AI4bl3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI4bl3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI5bl3_combo.SelectedItem.ToString() == s3 || AI5bl3_combo.SelectedItem.ToString() == s4 ||
                    AI5bl3_combo.SelectedItem.ToString() == s5)
            {   // AI5, блок 3
                if (AI5bl3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI5bl3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
            if (AI6bl3_combo.SelectedItem.ToString() == s3 || AI6bl3_combo.SelectedItem.ToString() == s4 ||
                    AI6bl3_combo.SelectedItem.ToString() == s5)
            {   // AI6, блок 3
                if (AI6bl3_typeCombo.SelectedIndex == 0) chanSensorTotal_ntc++;
                else if (AI6bl3_typeCombo.SelectedIndex == 1) chanSensorTotal_pt++;
            }
        }

        ///<summary>Поиск комнатного датчика температуры в таблицы сигналов по имени</summary>
        private void CheckRoomSensor_spec()
        {
            string s6 = "Датчик температуры комнатный";
            if (AI1_combo.SelectedItem.ToString() == s6)
            {   // AI1, ПЛК
                if (AI1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI2_combo.SelectedItem.ToString() == s6)
            {   // AI2, ПЛК
                if (AI2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI3_combo.SelectedItem.ToString() == s6)
            {   // AI3, ПЛК
                if (AI3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI4_combo.SelectedItem.ToString() == s6)
            {   // AI4, ПЛК
                if (AI4_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI4_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI5_combo.SelectedItem.ToString() == s6)
            {   // AI5, ПЛК
                if (AI5_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI5_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI6_combo.SelectedItem.ToString() == s6)
            {   // AI6, ПЛК
                if (AI6_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI6_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI1bl1_combo.SelectedItem.ToString() == s6)
            {   // AI1, блок 1
                if (AI1bl1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI1bl1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI2bl1_combo.SelectedItem.ToString() == s6)
            {   // AI2, блок 1
                if (AI2bl1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI2bl1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI3bl1_combo.SelectedItem.ToString() == s6)
            {   // AI3, блок 1
                if (AI3bl1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI3bl1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI4bl1_combo.SelectedItem.ToString() == s6)
            {   // AI4, блок 1
                if (AI4bl1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI4bl1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI5bl1_combo.SelectedItem.ToString() == s6)
            {   // AI5, блок 1
                if (AI5bl1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI5bl1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI6bl1_combo.SelectedItem.ToString() == s6)
            {   // AI6, блок 1
                if (AI6bl1_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI6bl1_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI1bl2_combo.SelectedItem.ToString() == s6)
            {   // AI1, блок 2
                if (AI1bl2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI1bl2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI2bl2_combo.SelectedItem.ToString() == s6)
            {   // AI2, блок 2
                if (AI2bl2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI2bl2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI3bl2_combo.SelectedItem.ToString() == s6)
            {   // AI3, блок 2
                if (AI3bl2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI3bl2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI4bl2_combo.SelectedItem.ToString() == s6)
            {   // AI4, блок 2
                if (AI4bl2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI4bl2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI5bl2_combo.SelectedItem.ToString() == s6)
            {   // AI5, блок 2
                if (AI5bl2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI5bl2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI6bl2_combo.SelectedItem.ToString() == s6)
            {   // AI6, блок 2
                if (AI6bl2_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI6bl2_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI1bl3_combo.SelectedItem.ToString() == s6)
            {   // AI1, блок 3
                if (AI1bl3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI1bl3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI2bl3_combo.SelectedItem.ToString() == s6)
            {   // AI2, блок 3
                if (AI2bl3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI2bl3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI3bl3_combo.SelectedItem.ToString() == s6)
            {   // AI3, блок 3
                if (AI3bl3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI3bl3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI4bl3_combo.SelectedItem.ToString() == s6)
            {   // AI4, блок 3
                if (AI4bl3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI4bl3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI5bl3_combo.SelectedItem.ToString() == s6)
            {   // AI5, блок 3
                if (AI5bl3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI5bl3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
            if (AI6bl3_combo.SelectedItem.ToString() == s6)
            {   // AI6, блок 3
                if (AI6bl3_typeCombo.SelectedIndex == 0) roomSensorTotal_ntc++;
                else if (AI6bl3_typeCombo.SelectedIndex == 1) roomSensorTotal_pt++;
            }
        }

        ///<summary>Поиск наружного датчика температуры в таблице сигналов по имени</summary>
        private void CheckOutSensor_spec()
        {
            string s7 = "Датчик температуры наружного воздуха";
            if (AI1_combo.SelectedItem.ToString() == s7)
            {   // AI1, ПЛК
                if (AI1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI2_combo.SelectedItem.ToString() == s7)
            {   // AI2, ПЛК
                if (AI2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI3_combo.SelectedItem.ToString() == s7)
            {   // AI3, ПЛК
                if (AI3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI4_combo.SelectedItem.ToString() == s7)
            {   // AI4, ПЛК
                if (AI4_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI4_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI5_combo.SelectedItem.ToString() == s7)
            {   // AI5, ПЛК
                if (AI5_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI5_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI6_combo.SelectedItem.ToString() == s7)
            {   // AI6, ПЛК
                if (AI6_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI6_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI1bl1_combo.SelectedItem.ToString() == s7)
            {   // AI1, блок 1
                if (AI1bl1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI1bl1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI2bl1_combo.SelectedItem.ToString() == s7)
            {   // AI2, блок 1
                if (AI2bl1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI2bl1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI3bl1_combo.SelectedItem.ToString() == s7)
            {   // AI3, блок 1
                if (AI3bl1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI3bl1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI4bl1_combo.SelectedItem.ToString() == s7)
            {   // AI4, блок 1
                if (AI4bl1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI4bl1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI5bl1_combo.SelectedItem.ToString() == s7)
            {   // AI5, блок 1
                if (AI5bl1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI5bl1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI6bl1_combo.SelectedItem.ToString() == s7)
            {   // AI6, блок 1
                if (AI6bl1_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI6bl1_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI1bl2_combo.SelectedItem.ToString() == s7)
            {   // AI1, блок 2
                if (AI1bl2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI1bl2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI2bl2_combo.SelectedItem.ToString() == s7)
            {   // AI2, блок 2
                if (AI2bl2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI2bl2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI3bl2_combo.SelectedItem.ToString() == s7)
            {   // AI3, блок 2
                if (AI3bl2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI3bl2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI4bl2_combo.SelectedItem.ToString() == s7)
            {   // AI4, блок 2
                if (AI4bl2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI4bl2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI5bl2_combo.SelectedItem.ToString() == s7)
            {   // AI5, блок 2
                if (AI5bl2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI5bl2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI6bl2_combo.SelectedItem.ToString() == s7)
            {   // AI6, блок 2
                if (AI6bl2_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI6bl2_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI1bl3_combo.SelectedItem.ToString() == s7)
            {   // AI1, блок 3
                if (AI1bl3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI1bl3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI2bl3_combo.SelectedItem.ToString() == s7)
            {   // AI2, блок 3
                if (AI2bl3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI2bl3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI3bl3_combo.SelectedItem.ToString() == s7)
            {   // AI3, блок 3
                if (AI3bl3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI3bl3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI4bl3_combo.SelectedItem.ToString() == s7)
            {   // AI4, блок 3
                if (AI4bl3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI4bl3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI5bl3_combo.SelectedItem.ToString() == s7)
            {   // AI5, блок 3
                if (AI5bl3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI5bl3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
            if (AI6bl3_combo.SelectedItem.ToString() == s7)
            {   // AI6, блок 3
                if (AI6bl3_typeCombo.SelectedIndex == 0) outSensorTotal_ntc++;
                else if (AI6bl3_typeCombo.SelectedIndex == 1) outSensorTotal_pt++;
            }
        }

        ///<summary>Поиск датчиков обратной воды в таблице сигналов по имени</summary>
        private void CheckWatSensor_spec()
        {
            string s8 = "Датчик обратной воды калорифера";
            string s9 = "Датчик обратной воды догревателя";
            if (AI1_combo.SelectedItem.ToString() == s8 || AI1_combo.SelectedItem.ToString() == s9)
            {   // AI1, ПЛК
                if (AI1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI2_combo.SelectedItem.ToString() == s8 || AI2_combo.SelectedItem.ToString() == s9)
            {   // AI2, ПЛК
                if (AI2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI3_combo.SelectedItem.ToString() == s8 || AI3_combo.SelectedItem.ToString() == s9)
            {   // AI3, ПЛК
                if (AI3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI4_combo.SelectedItem.ToString() == s8 || AI4_combo.SelectedItem.ToString() == s9)
            {   // AI4, ПЛК
                if (AI4_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI5_combo.SelectedItem.ToString() == s8 || AI5_combo.SelectedItem.ToString() == s9)
            {   // AI5, ПЛК
                if (AI5_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI6_combo.SelectedItem.ToString() == s8 || AI6_combo.SelectedItem.ToString() == s9)
            {   // AI6, ПЛК
                if (AI6_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI1bl1_combo.SelectedItem.ToString() == s8 || AI1bl1_combo.SelectedItem.ToString() == s9)
            {   // AI1, блок 1
                if (AI1bl1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI2bl1_combo.SelectedItem.ToString() == s8 || AI2bl1_combo.SelectedItem.ToString() == s9)
            {   // AI2, блок 1
                if (AI2bl1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI3bl1_combo.SelectedItem.ToString() == s8 || AI3bl1_combo.SelectedItem.ToString() == s9)
            {   // AI3, блок 1
                if (AI3bl1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI4bl1_combo.SelectedItem.ToString() == s8 || AI4bl1_combo.SelectedItem.ToString() == s9)
            {   // AI4, блок 1
                if (AI4bl1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI5bl1_combo.SelectedItem.ToString() == s8 || AI5bl1_combo.SelectedItem.ToString() == s9)
            {   // AI5, блок 1
                if (AI5bl1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI6bl1_combo.SelectedItem.ToString() == s8 || AI6bl1_combo.SelectedItem.ToString() == s9)
            {   // AI6, блок 1
                if (AI6bl1_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI1bl2_combo.SelectedItem.ToString() == s8 || AI1bl2_combo.SelectedItem.ToString() == s9)
            {   // AI1, блок 2
                if (AI1bl2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI2bl2_combo.SelectedItem.ToString() == s8 || AI2bl2_combo.SelectedItem.ToString() == s9)
            {   // AI2, блок 2
                if (AI2bl2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI3bl2_combo.SelectedItem.ToString() == s8 || AI3bl2_combo.SelectedItem.ToString() == s9)
            {   // AI3, блок 2
                if (AI3bl2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI4bl2_combo.SelectedItem.ToString() == s8 || AI4bl2_combo.SelectedItem.ToString() == s9)
            {   // AI4, блок 2
                if (AI4bl2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI5bl2_combo.SelectedItem.ToString() == s8 || AI5bl2_combo.SelectedItem.ToString() == s9)
            {   // AI5, блок 2
                if (AI5bl2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI6bl2_combo.SelectedItem.ToString() == s8 || AI6bl2_combo.SelectedItem.ToString() == s9)
            {   // AI6, блок 2
                if (AI6bl2_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI1bl3_combo.SelectedItem.ToString() == s8 || AI1bl3_combo.SelectedItem.ToString() == s9)
            {   // AI1, блок 3
                if (AI1bl3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI2bl3_combo.SelectedItem.ToString() == s8 || AI2bl3_combo.SelectedItem.ToString() == s9)
            {   // AI2, блок 3
                if (AI2bl3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI3bl3_combo.SelectedItem.ToString() == s8 || AI3bl3_combo.SelectedItem.ToString() == s9)
            {   // AI3, блок 3
                if (AI3bl3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI4bl3_combo.SelectedItem.ToString() == s8 || AI4bl3_combo.SelectedItem.ToString() == s9)
            {   // AI4, блок 3
                if (AI4bl3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI5bl3_combo.SelectedItem.ToString() == s8 || AI5bl3_combo.SelectedItem.ToString() == s9)
            {   // AI5, блок 3
                if (AI5bl3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
            if (AI6bl3_combo.SelectedItem.ToString() == s8 || AI6bl3_combo.SelectedItem.ToString() == s9)
            {   // AI6, блок 3
                if (AI6bl3_typeCombo.SelectedIndex == 1)
                {
                    watSensorTotal_pt++; sleeveForSensorTotal++;
                }
            }
                ...
                if (AO1bl1_lab.Text == "" && AO2bl1_lab.Text == "" && AO3bl1_lab.Text == "")
                    if (AI1bl1_lab.Text == "" && AI2bl1_lab.Text == "" && AI3bl1_lab.Text == "" &&
                        ...
                        if (DI1bl1_lab.Text == "" && DI2bl1_lab.Text == "" && DI3bl1_lab.Text == "" &&
                            DI4bl1_lab.Text == "" && DI5bl1_lab.Text == "")
                            return false;
            return true;
        }
                ...
                if (AO1bl2_lab.Text == "" && AO2bl2_lab.Text == "" && AO3bl2_lab.Text == "")
                    if (AI1bl2_lab.Text == "" && AI2bl2_lab.Text == "" && AI3bl2_lab.Text == "" &&
                        ...
                        if (DI1bl2_lab.Text == "" && DI2bl2_lab.Text == "" && DI3bl2_lab.Text == "" &&
                            DI4bl2_lab.Text == "" && DI5bl2_lab.Text == "")
                            return false;
            return true;
        }
                ...
                if (AO1bl3_lab.Text == "" && AO2bl3_lab.Text == "" && AO3bl3_lab.Text == "")
                    if (AI1bl3_lab.Text == "" && AI2bl3_lab.Text == "" && AI3bl3_lab.Text == "" &&
                        ...
                        if (DI1bl3_lab.Text == "" && DI2bl3_lab.Text == "" && DI3bl3_lab.Text == "" &&
                            DI4bl3_lab.Text == "" && DI5bl3_lab.Text == "")
                            return false;
            return true;
        }
