...
- добавлен `label_progVersion` на Form1 с версией программы - `Конструктор`
...
- создан `outFanCheck` для выбора вытяжного вентилятора - `Конструктор`
...
- добавлен файл формы для проверки обновления `UpdateForm.cs`
...
- обновление прошивок `mini_19055` и `opt_19055` на новые

22.08.25 (пятница)

- формирование сообщения об ошибке при загрузке прошивки - `LoadCan.cs`
- добавлена поясняющая информация при ошибке загрузки
- обновление на сервере версии `v.1.2.1.8` - `myhost`
